...
cargo run --features=uniffi/cli --bin uniffi-bindgen generate --out-dir generated/swift/ --language swift target/aarch64-apple-ios-sim/release/libdpkg_rs.dylib
